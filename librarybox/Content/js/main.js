...
$j(document).ready(function() {
    ...
    $j.getJSON("/config.json" , function(data) {
        ...
        var uploadbox = data.librarybox.module.upload.status;
        var uploadhost = data.librarybox.module.upload.droopy_host;
        var uploadport = data.librarybox.module.upload.droopy_port;
        if (uploadbox && uploadhost && uploadport) {
            var address = "http://".concat(uploadhost,":",uploadport);
            document.getElementById("uploadframe").src=address;
